...
public class ProxyInfo {
    ...
    String generateJavaCode() throws OnceClickException {
        ...
        builder.append("import com.shang.onceclick.Finder;\n");
        builder.append("import com.shang.onceclick.AbstractInjector;\n");
        builder.append('\n');
    ...
    private void generateInjectMethod(StringBuilder builder) throws OnceClickException {
        ...
        for (OnceMethod method : getMethods()) {
            index++;
            builder.append("final int intervalTime"+index+" = ")
                    .append(method.getTime())
                    .append(";\n")
                    .append("view = ")
            ...
            builder.append("long temp = System.currentTimeMillis();\n")
                    .append("if (temp - time >= intervalTime"+index+") {\n" +
                            "time = temp;\n");
